...
function Main() {
  ...
  return (
    <div className='flex flex-col flex-1 mt-4 min-h-screen relative'>
        <div className='flex h-[10%] md:h-[50px] items-center text-green-900 text-[20px] px-3 justify-between min-w-full'>
            <p>Gemini</p>
        ...
        <div className='px-2 mx-auto md:mb-4'>
            <div className='flex items-center justify-between px-2 md:py-1 bg-slate-300 rounded-[50px] '>
                <input onChange={(e) => setInput(e.target.value)} value={input} className='flex flex-1 bg-transparent outline-none border-none p-[2px] md:p-1 text-[14px] md:text-[16px] ' placeholder='Enter prompt here' />
